/**
 * Url      : db://assets/scripts/base/func/md5.ts
 * Author   : reyn
...
class MD5 {
    ...
    private static RotateLeft: Function = (lValue: number, iShiftBits: number): number =>
     ...
     * @returns
     */
    public static init(target: any): string {
        let temp: string;

        if (typeof target !== "string") target = JSON.stringify(target);

        this._string = this.Utf8Encode(target);
